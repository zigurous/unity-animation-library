...
- New `ShaderProperty` data structure (similar to `AnimatorParameter` but for shaders)
- New classes for smooth damping additional types
  - `SmoothDampColor`
  - `SmoothDampShaderProperty`
  - `SmoothDampShaderPropertyColor`
  - `SmoothDampShaderPropertyFloat`
- New classes for animating shader properties
  - `AnimatedShaderProperty`
  - `AnimatedShaderPropertyColor`
  - `AnimatedShaderPropertyFloat`
  - `AnimatedShaderPropertyInt`
